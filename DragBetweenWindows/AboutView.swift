        ...
        NavigationStack {
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    Text("Drag Between Windows")
                        .font(.largeTitle)
                        .fontWeight(.semibold)
                        .multilineTextAlignment(.center)

                    Text("A SwiftUI cross-window drag-and-drop demo")
                        .font(.title3)
                        .foregroundStyle(.secondary)
                        .multilineTextAlignment(.center)

                    Text("Build-Along 10 of Claude's X26 Swift 6 Bible")
                        .font(.callout)
                        .foregroundStyle(.secondary)
                        .multilineTextAlignment(.center)
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        Link("Send Feedback", destination: URL(string: "mailto:michael.fluharty@mac.com?subject=DragBetweenWindows%20Feedback")!)
